...
class LatestCommentView extends \yii\base\Widget
{
    ...
    public $itemTemplate = '<li>
                    <a href="{%HREF%}" title="">
                        <img class="avatar avatar-72" height="50"width="50" src="{%AVATAR%}" style="display: block;">
                        <div class="muted">
    ...
    public function run()
    {
        ...
        foreach ($models as $model){
            ...
            $item = str_replace("{%AVATAR%}", Yii::$app->getRequest()->getBaseUrl() . "static/images/comment-user-avatar2.png", $item);
